/**
 * Deposit test for private-payment contract
 * Deploys the contract, then executes a deposit and checks the balance.
 *
 * Usage: npm run deposit-test
 */
...
// ─── Wallet Setup (reuses saved seed) ─────────────────────────────────────────
...
async function main() {
  console.log('\n╔══════════════════════════════════════════════════════════════╗');
  console.log('║          Private Payment - Deposit Test                     ║');
  console.log('╚══════════════════════════════════════════════════════════════╝\n');
  ...
  try {
    ...
    console.log(`  Tx hash: ${(depositResult.public as any)?.txHash ?? 'pending'}\n`);
  } catch (err: any) {
  ...
  try {
    ...
    console.log(`  Balance: ${(balanceResult.public as any)?.result ?? 'unknown'}\n`);
  } catch (err: any) {
